...
type CreateDiscountPayload = Record<string, unknown>;
...
const parseEventPayload = (payload: CreateDiscountPayload): DiscountInput => {
...
export const createDiscountFromPayload = async (
